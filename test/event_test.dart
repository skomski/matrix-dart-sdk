...
void main() async {
  ...
  group('Event', () {
    ...
    test('sendAgain', () async {
      ...
      // in the content yet: the thumbnail must get an image file name with
      // the jpg fallback extension instead of a literal ".null" suffix.
      ...
      FakeMatrixApi
              .currentApi!
              .api['POST']!['/media/v3/upload?filename=$videoFilename.thumbnail.jpg'] =
      ...
      expect(
        FakeMatrixApi
            .calledEndpoints['/media/v3/upload?filename=$videoFilename.thumbnail.jpg']
            ?.length,
        1,
      );
